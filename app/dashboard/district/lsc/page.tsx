...
export default function UserManagementPage() {
  ...
  const loadUsers = async () => {
    ...
    try {
      ...
      console.log('Fetched LSCs:', fetchedData);
              ...
              {loading ? (
                ...
                paginatedUsers.map((u) => (
                  <tr key={u.id} className="hover:bg-slate-50 transition-colors">
                    <td className="px-6 py-4  text-slate-900">{u.lsc_name}</td>
                    <td className="px-6 py-4">
                      <div className="text-xs">{u.district}</div>
                      <div className="text-[10px] uppercase">{u.block}</div>
                    </td>
                    {/* block status */}
                    <td className="px-6 py-4">
                    ...
                    <td className="px-6 py-4">
                      ...
                      <div className="text-[10px] uppercase">{u.district_remarks}</div>
                    ...
                    <td className="px-6 py-4">
                      ...
                      <div className="text-[10px] uppercase">{u.state_remarks}</div>
