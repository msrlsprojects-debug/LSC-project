...
import { Menu, X, LayoutDashboard, User, ShieldCheck, Layers, LogOut, ChevronRight } from 'lucide-react';
...
export default function LSCProfileLayout({ children }: { children: ReactNode }) {
  ...
  const navLinks = [
    { name: 'Dashboard', href: '/dashboard/lsc', icon: LayoutDashboard },
    { name: 'Services', href: '/dashboard/lsc/services', icon: Layers },
    { name: 'Profile', href: '/dashboard/lsc/profile', icon: ShieldCheck },
  ];
        ...
        <div className="max-w-6xl mx-auto px-4 h-16 md:h-20 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden sm:block border-l border-white/20 pl-4">
              ...
              <p className="text-[9px] text-blue-200 font-medium uppercase mt-0.5 tracking-[0.2em]">LSC Login</p>
            </div>
          </div>
